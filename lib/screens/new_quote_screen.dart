...
class _NewQuoteScreenState extends State<NewQuoteScreen> {
  ...
  Widget build(BuildContext context) {
                    ...
                    return Align(
                      ...
                      child: Material(
                        ...
                        child: ConstrainedBox(
                          constraints: BoxConstraints(maxHeight: 240, maxWidth: isWideScreen ? 500 : 420),
    ...
    Widget addedServicesCard = Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
          "Servicios Añadidos",
    ...
    Widget observationsCard = Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
